<x-guest-layout>
    <div class="relative z-10 pt-52 pb-64 bg-cover bg-center" style="background-image: url(/img/hero-bg.jpg)">
        ...
        <div class="container relative z-20 text-white text-center text-2xl">
            <h2 class="font-bold text-5xl mb-8">Lorem, ipsum dolor sit amet <br>consectetur adipisicing elit. Eveniet,
                voluptas!</h2>
    ...
    <div class="py-32 text-center">
        <div class="container">
            <h2 class="font-bold text-4xl mb-6">Lorem ipsum dolor sit amet consectetur<br /> adipisicing elit. Nulla
                autem pariatur sapiente! <span class="underline"> minima porro eos</span></h2>
            <p class="text-gray-500 text-2xl mb-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus,
                molestias!</p>
            <a class="border-2 border-gray-500 rounded-2xl text-2xl px-12 py-2 inline-block" href="http://">Start The
                Searching</a>

            <h2 class="font-bold text-4xl mb-6 mt-20">Lorem ipsum dolor sit amet consectetur<br /> adipisicing elit.
                Ducimus, tenetur.</span></h2>
